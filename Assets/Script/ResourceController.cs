...
public class ResourceController : MonoBehaviour
{
    ...
    public void UpgradeLevel()
    {
        ...
        if (/*GameManager.Instance._totalGold*/ UserDataManager.Progress.Gold < upgradeCost)
        {
            return;
        }
    ...
    public void UnlockResource()
    {
        ...
        if (/*GameManager.Instance._totalGold*/ UserDataManager.Progress.Gold < unlockCost)
        {
            return;
        }
        SetUnlocked(true);
